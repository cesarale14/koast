  ...
  return (
    <div className="bg-white rounded-xl border border-[var(--border)] overflow-hidden max-w-md mx-auto">
      {photo ? (
        ...
        <div className="h-44 bg-gradient-to-br from-brand-50 to-[var(--brand-100)] flex items-center justify-center"><Home size={36} className="text-[var(--brand-200)]" strokeWidth={1.5} /></div>
      )}
          ...
          {step === 4 && (
            <div className="flex items-center justify-center py-12">
              <div className="text-center max-w-sm">
                <div className="w-16 h-16 bg-brand-50 rounded-full flex items-center justify-center mx-auto mb-6"><Check size={32} className="text-tideline" strokeWidth={2.5} /></div>
